...
const form=document.getElementById('estimate-form');if(form)form.addEventListener('submit',e=>{e.preventDefault();const d=new FormData(form);const body=`Hi Valid Tree Service, I'd like to discuss a project bid or estimate.\n\nName: ${d.get('name')}\nPhone: ${d.get('phone')}\nAddress: ${d.get('address')}\nService: ${d.get('service')}\nProject: ${d.get('details')}\n\nI can attach photos in this text.`;location.href=`sms:+18324456535?&body=${encodeURIComponent(body)}`});
